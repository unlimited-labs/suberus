...
UPDATE "review_assignments" SET "status" = 'PENDING' WHERE "status" = 'IN_PROGRESS';
...
ALTER TABLE "review_assignments" ALTER COLUMN "status" DROP DEFAULT;
ALTER TABLE "review_assignments" ALTER COLUMN "status" TYPE "AssignmentStatus_new" USING ("status"::text::"AssignmentStatus_new");
...
ALTER TABLE "review_assignments" ALTER COLUMN "status" SET DEFAULT 'PENDING';

-- Delete orphaned REVIEW_STARTED activity logs
DELETE FROM "activity_log" WHERE "type" = 'REVIEW_STARTED';
...
ALTER TABLE "activity_log" ALTER COLUMN "type" TYPE "ActivityType_new" USING ("type"::text::"ActivityType_new");
