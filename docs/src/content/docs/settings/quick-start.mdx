...
**Settings** screen. The goal now is a working baseline, not perfection.
</Aside>
...
1. **Sign in and open Settings.**
   Log in with your admin account. In the left sidebar choose **Settings**.
...
3. **Choose what people can submit** *(Submission Types tab)*.
   ...
   **Full Paper** — and turn off the rest. For each enabled type set how many
   ...
   → Full details: **[Submission Types](/settings/submission-types/)**.
...
9. **Invite your reviewers and co-organisers** *(Managing › Invitations)*.
   ...
   set on **[Settings › Invitations](/settings/invitations/)**.
...
<CardGrid>
	<LinkCard title="First-time install" href="/settings/first-time-install/" description="Create the conference and the first admin account." />
	<LinkCard title="Submission Types" href="/settings/submission-types/" description="Decide what people can submit and how it's reviewed." />
	<LinkCard title="Conference" href="/settings/conference/" description="Identity, key dates, and date/time format." />
	<LinkCard title="Email Templates" href="/settings/email-templates/" description="Review and test the automatic emails." />
</CardGrid>
