...
| **Contact Email** | Receives admin notifications (new submissions, new registrations), and is set as the **Reply-To** on every system email. | A monitored mailbox — this is your public contact point. System mail is sent from a no-reply address, so without this a reply goes nowhere. Leave blank to send no Reply-To. |
...
<CardGrid>
	...
	<LinkCard title="AI assistant" href="/managing/ai-assistant/" description="An assistant can read and change everything on this tab." />
</CardGrid>
