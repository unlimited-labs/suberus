...
**Settings › Reminders.** Three groups: *Reviewer reminders*, *Revision
...
edited on the **[Email Templates](/settings/email-templates/)** tab.
</Aside>
...
| **Days before deadline** | When to send, relative to the review deadline. | Comma-separated whole numbers from 1 to 365, e.g. `7, 3, 1`. Between one and ten values. |
...
| **Interval (days)** | How many days between successive reminders. | A whole number from 1 to 365. |
| **Max reminders** | How many reminders to send at most. | A whole number from 1 to 50 — stops nagging after this count. |
...
| **Days before deadline** | When to send, relative to the deadline. | Comma-separated whole numbers from 1 to 365, e.g. `7, 3, 1`. Between one and ten values. |

## Related

<CardGrid>
	<LinkCard title="Email Templates" href="/settings/email-templates/" description="The wording of every reminder email." />
	<LinkCard title="Conference" href="/settings/conference/" description="The deadlines reminders count down to." />
</CardGrid>
