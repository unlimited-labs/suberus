...
- **On the verification page** — anyone can open **`/verify-document`**, upload
  the PDF, and instantly see **“Authentic — signed by …”** or a tamper warning.
...
| **Embed the branding logo** | Draws your logo faintly behind the seal text. Uses your [branding](/settings/branding/) logo (PNG, JPG or SVG); falls back to the default logo when no custom branding is set. | Off by default. |
...
<CardGrid>
	...
	<LinkCard title="Branding" href="/settings/branding/" description="The logo embedded in the signature seal." />
</CardGrid>
