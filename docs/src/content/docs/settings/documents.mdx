...
| **Upload your own .p12** | Use an organizational or qualified certificate for full trust. | A `.p12`/`.pfx` file under 1 MB, plus the password that opens it. Any other file type is refused before upload. |
