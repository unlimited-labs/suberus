...
|---|---|---|
| **Invitation validity (hours)** | How long an invitation link works before it expires. | A whole number from 1 to 8760 (one year), in hours. After this, the recipient must be re-invited. |
