...
5. Sign in with the admin account, then continue with the
   **[Quick start](/settings/quick-start/)**.
...
|---|---|---|
| **Conference Name** | The initial name of your conference. | You can refine it later on the **[Conference](/settings/conference/)** tab. |
...
<CardGrid>
	<LinkCard title="Quick start" href="/settings/quick-start/" description="The next step after signing in." />
	<LinkCard title="Roles & permissions" href="/settings/roles-and-permissions/" description="What the admin role can do." />
</CardGrid>
