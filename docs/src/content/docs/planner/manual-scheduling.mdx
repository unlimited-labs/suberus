...
Turn on **Untimed presentations** — either in the **+ Create session** dialog you
get from a sidebar selection, or later in the **session editor** — and the session
...
**Session length (minutes)**; in the session editor it replaces **Slots** ×
**Min / slot** with an **End** field. The **+ New** dialog always creates a timed
session — turn the toggle on in the editor afterwards.
