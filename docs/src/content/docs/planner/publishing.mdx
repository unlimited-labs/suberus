...
- If **Publish participant contact details** is enabled (**Settings › Program ›
  ...
  author's name, **affiliation**, **email**, and **ORCID** link. **Back to talk**
  returns to the preview.
- **Email and ORCID appear only for authors who consented** to publishing their
...
- The same setting adds a **Participants** link to the program header, visible only to
  ...
  **affiliation**, **email** and **ORCID**; everyone else is listed as plain text, name
