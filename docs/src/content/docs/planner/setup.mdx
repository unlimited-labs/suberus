...
**Configuration › Program** holds the *Planner*, *Rooms*, and *Program Tracks*
sections (the *Planner* section has its own **Save**; rooms and tracks save as you
create them). The **conference dates and timezone** live on
**[Configuration › Conference](/configuration/conference/)**.
</Aside>
...
The planner reads two things from the **[Conference](/configuration/conference/)**
tab:
...
1. On **[Conference](/configuration/conference/)**, set the **Conference Start/End**
   dates and the **Conference Timezone**.

2. On **Program › Planner**, set the **visible hours** and a **default presentation
   length**, then **Save**.

3. On **Program › Rooms**, click **Create Room** for each physical (or virtual)
   location.

4. *(Optional)* On **Program › Program Tracks**, create colour tags to group related
   sessions.
...
**[Tracks](/configuration/tracks/)** on the *Tracks* tab group *submissions* and are
...
<CardGrid>
	...
	<LinkCard title="Conference" href="/configuration/conference/" description="Dates & timezone the planner depends on." />
	<LinkCard title="Tracks" href="/configuration/tracks/" description="The separate, subject-based submission tracks." />
