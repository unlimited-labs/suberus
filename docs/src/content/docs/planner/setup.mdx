...
1. On **[Conference](/settings/conference/)**, set the **Conference Start/End**
...
🖼️ [Screenshot placeholder: Settings › Program › Appearance theme selector]

| Field | What it does | What to enter / Notes |
|---|---|---|
| **Theme** | Visual style of the public program page. | **Default** follows your **[branding](/settings/branding/)** primary colour and adapts to light/dark; **Editorial** is a print-inspired newspaper look with its own fixed palette (ignores branding); **Academic** is a formal **room-by-time timetable grid** (rooms as columns, time as rows; collapses to a list on phones) with its own fixed scholarly ink/navy palette (ignores branding). |
