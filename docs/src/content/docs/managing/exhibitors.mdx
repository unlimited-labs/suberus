...
**Exhibitors** section of **[Settings › Conference](/settings/conference/)** —
...
power requirements, banner artwork? On the **[Survey](/settings/survey/)** tab set a
...
<CardGrid>
	<LinkCard title="Conference" href="/settings/conference/" description="Enable exhibitors and the optional presentation (Exhibitors section)." />
