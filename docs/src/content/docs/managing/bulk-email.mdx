...
2. Write a **Subject** and **Body**, choosing a **Format** (see below). The preview
   updates as you type.
3. Click **Send test** to receive the message at your own address, with
   placeholders filled from random sample data — useful to check formatting.
4. Click **Send campaign**. The campaign is queued and delivered one recipient at a
   time; a progress bar shows how many have been processed.
...
| **Copy to new draft** | Shown once a campaign has been sent: clones the subject, body, format, and the exact recipient list into a fresh draft you can edit and resend. |
