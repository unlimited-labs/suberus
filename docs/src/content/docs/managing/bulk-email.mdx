...
1. Write a **Subject** and **Body**, choosing a **Format** (see below). The preview
   updates as you type. **Send test** and **Send campaign** stay disabled until both
   the subject and body are filled in.
...
| **Copy to new draft** | Shown once a campaign has been sent: clones the subject, body, format, attachments, and the exact recipient list into a fresh draft you can edit and resend. |
