...
menu and choose **Send email**. Click **Apply** and Suberus creates the draft, opening
the composer with exactly those users attached.
...
1. Write a **Subject** and **Body**, choosing a **Format** (see below). The preview
   updates as you type.
