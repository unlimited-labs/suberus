...
1. Write a **Subject** and **Body**, choosing a **Format** (see below). Optionally set
   a **Reply-To** address so replies reach you (or the organizer) instead of the
   platform's sending mailbox. The preview updates as you type. **Send test** and
...
| **Reply-To** | Optional. A single email address. If set, replies go here instead of the platform's sending mailbox. Leave blank for the default. |
