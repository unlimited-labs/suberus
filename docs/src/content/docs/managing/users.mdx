...
| Action | What it does |
|---|---|
| **Change role** | Promote/demote between Author, Reviewer, Editor, Admin. Reviewers (and above) can be assigned to review. Editors can change roles but cannot grant **Admin** or change an existing admin; no one can change their own role. |
...
![User detail with management actions](../../../assets/screenshots/22-managing-user-detail.png)
