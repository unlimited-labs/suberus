...
| **Submission events** | Creation, submission, status transitions (with from/to, round, reason), withdrawal, resubmission, revised-version uploads (conditional acceptance), track changes. |
