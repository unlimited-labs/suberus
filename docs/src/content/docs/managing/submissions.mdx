...
| **Attached file** | The file name on each side, each with a **Download** button to fetch that version's original file, plus a **File changed / File unchanged** indication. |
