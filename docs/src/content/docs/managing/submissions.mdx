...
**Side-by-side / Inline** toggle drives the text fields (Title, Content, File
contents): side-by-side reconstructs the old and new value in two columns, inline
shows one unified redline. **Authors** and **Keywords** are compared *structurally*
instead — each entry is tagged **added**, **removed**, **moved**, or **changed**
(see below), so the toggle does not affect them.
