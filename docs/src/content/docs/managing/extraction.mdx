...
(title, authors, keywords, and — for types with the acknowledgment field enabled —
the **acknowledgment**) so authors don't retype them. Extraction runs in the
**background** after an upload; you mostly just keep an eye on whether the backing
services are healthy.

<Aside type="note" title="Where it's set up">
Extraction is turned on and tuned on the **[Submissions configuration](/settings/submissions/)**
...
<CardGrid>
	<LinkCard title="Submissions (configuration)" href="/settings/submissions/" description="Enable extraction and choose engines." />
