...
**Configuration › Branding.** Four sections — *Logo & Graphics*, *Auth Background
...
<CardGrid>
	<LinkCard title="Conference" href="/configuration/conference/" description="Name and contact shown alongside branding." />
	<LinkCard title="Email Templates" href="/configuration/email-templates/" description="The email footer is set there, separately from this page footer." />
</CardGrid>
