...
**Configuration › Tracks.** Existing tracks are listed; **Create Track** opens a
dialog.
</Aside>
...
<CardGrid>
	<LinkCard title="Submission Types" href="/configuration/submission-types/" description="Enable author track selection." />
