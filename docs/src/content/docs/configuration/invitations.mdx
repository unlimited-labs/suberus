...
**Configuration › Invitations.** Sending and tracking individual invitations is
...
<CardGrid>
	...
	<LinkCard title="Conference" href="/configuration/conference/" description="Close registration / Registration Deadline — invited users can still register when public registration is closed." />
</CardGrid>
