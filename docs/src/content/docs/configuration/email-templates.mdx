...
**Configuration › Email Templates.** A *footer* section at the top, then a card per
...
<CardGrid>
	<LinkCard title="Reminders" href="/configuration/reminders/" description="Controls when reminder emails are sent." />
	<LinkCard title="Branding" href="/configuration/branding/" description="The page footer (separate from this email footer)." />
</CardGrid>
