...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        "no-scrollbar max-h-72 scroll-py-1 outline-none overflow-x-hidden overflow-y-auto fade-y",
        className
      )}
      {...props}
    />
...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      <IconCheck className="ml-auto size-4 opacity-0 group-has-[[data-slot=command-shortcut]]/command-item:hidden group-data-[checked=true]/command-item:opacity-100" />
    </CommandPrimitive.Item>
  )
}
